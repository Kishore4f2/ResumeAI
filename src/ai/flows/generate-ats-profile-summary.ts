...
const GenerateAtsProfileSummaryOutputSchema = z.object({
  profileSummary: z
    .string()
    .describe(
      `A 7 line profile summary tailored for fresher resumes, optimized for ATS.`
    ),
